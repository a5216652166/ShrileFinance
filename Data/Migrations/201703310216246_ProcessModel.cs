namespace Data.Migrations
{
    ...
    public partial class ProcessModel : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.FLOW_InstanceData", "InstanceId", "dbo.FLOW_Instance");
            ...
            DropIndex("dbo.FLOW_InstanceData", new[] { "InstanceId" });
            ...
            DropTable("dbo.FLOW_InstanceData");

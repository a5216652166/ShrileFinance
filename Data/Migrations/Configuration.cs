    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyContext>
    {
        ...
        private void FlowSeed(MyContext context)
        {
            ...
            context.Set<Node>().AddOrUpdate(
                ...
                // 财务打款
                new Node { Id = new Guid("{1295D79F-08A4-E611-80C5-507B9DE4A488}"), FlowId = new Guid("{228C8C80-06A4-E611-80C5-507B9DE4A488}"), RoleId = "C142BEE1-05A4-E611-80C5-507B9DE4A488", Name = "财务打款" },
            ...
            context.Set<Form>().AddOrUpdate(
                ...
                // 运营审核  (运营初审、运营复审)
                new Form { Id = new Guid("{16DC5FCF-18A4-E611-80C5-507B9DE4A488}"), FlowId = new Guid("{228C8C80-06A4-E611-80C5-507B9DE4A488}"), Name = "运营审核", Link = "../Finance/FinanceApproval.html", Sort = 200 },
                
                // 财务打款
                new Form { Id = new Guid("{17DC5FCF-18A4-E611-80C5-507B9DE4A488}"), FlowId = new Guid("{228C8C80-06A4-E611-80C5-507B9DE4A488}"), Name = "财务信息", Link = "../Finance/LoanInfo.html", Sort = 200 },
            ...
            context.Set<FormNode>().AddOrUpdate(
                ...
                new FormNode { NodeId = new Guid("{2F95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },
                
                // 风控复审

                new FormNode { NodeId = new Guid("{3F95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },

                // 总经理审批(风控)

                new FormNode { NodeId = new Guid("{4F95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },

                // 放款资料整理

                new FormNode { NodeId = new Guid("{5F95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },

                // 放款资料上传

                new FormNode { NodeId = new Guid("{6F95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },

                // 运营初审

                new FormNode { NodeId = new Guid("{7F95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },

                // 运营复审

                new FormNode { NodeId = new Guid("{8F95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },

                // 总经理审批(放款)

                new FormNode { NodeId = new Guid("{9F95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },

                // 财务打款

                new FormNode { NodeId = new Guid("{AF95D79F-08A4-E611-80C5-507B9DE4A488}"), FormId = new Guid("{FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE}"), State = FormStateEnum.禁用, IsOpen = false, IsHandler = false },
            ...
            context.Set<FormRole>().AddOrUpdate(
                ...
                ////new FormRole { RoleId = "C442BEE1-05A4-E611-80C5-507B9DE4A488", FormId = new Guid("FFFFFFFF-EEEE-EEEE-EEEE-EEEEEEEEEEEE") },

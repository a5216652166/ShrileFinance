namespace Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MyContext>
    {
        ...
        private void FlowSeed(MyContext context)
        {
            ...
            new FAction { Id = new Guid("{A86FA6EB-62D1-E611-80CA-507B9DE4A488}"), NodeId = new Guid("{ABEDA2A7-79D1-E611-80CA-507B9DE4A488}"), TransferId = new Guid("{ACEDA2A7-79D1-E611-80CA-507B9DE4A488}"), Name = "提交", Type = ActionTypeEnum.发起, AllocationType = ActionAllocationEnum.无, Method = "CreditContract" },

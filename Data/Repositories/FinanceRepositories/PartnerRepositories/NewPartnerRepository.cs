namespace Data.Repositories.FinanceRepositories.PartnerRepositories
{
    ...
    public class NewPartnerRepository : BaseRepository<NewPartner>, INewPartnerRepository
    {
        public NewPartnerRepository(MyContext context) : base(context)
        {
        }
        ...
        IPagedList<NewPartner> INewPartnerRepository.PartnerList(string searchString, int page, int size, DateTime? beginTime, DateTime? endTime)
        {

namespace Data.ModelConfigurations.ProduceConfigurations
{
    ...
    /// 产品实体
    /// </summary>
    public class OldProduceConfigration : EntityTypeConfiguration<OldProduce>
    {
        public OldProduceConfigration()
        {
            HasKey(m => m.Id);

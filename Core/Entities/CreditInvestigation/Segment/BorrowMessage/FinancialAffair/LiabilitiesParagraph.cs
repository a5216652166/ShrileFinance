namespace Core.Entities.CreditInvestigation.Segment.BorrowMessage.FinancialAffair
{
    ...
    public class LiabilitiesParagraph : AbsSegment
    {
        ...
        /// 流动负债合计
        /// </summary>
        [MetaCode(20, MetaCodeTypeEnum.Amount), SegmentRule(862, true)]
        ...
        /// 非流动负债合计
        /// </summary>
        [MetaCode(20, MetaCodeTypeEnum.Amount), SegmentRule(1022, true)]
        public string TotalNonNurrentLiabilities { get; set; }

        /// <summary>
        /// 负债合计
        /// </summary>
        [MetaCode(20, MetaCodeTypeEnum.Amount), SegmentRule(1042, true)]
        ...
        /// 所有者权益合计
        /// </summary>
        [MetaCode(20, MetaCodeTypeEnum.Amount), SegmentRule(1162, true)]
        public string TotalOwnersEquity { get; set; }

        /// <summary>
        /// 负债和所有者权益合计
        /// </summary>
        [MetaCode(20, MetaCodeTypeEnum.Amount), SegmentRule(1182, true)]
